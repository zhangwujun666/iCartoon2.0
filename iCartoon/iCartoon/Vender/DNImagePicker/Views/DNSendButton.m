...
static NSString *const dnSendButtonTintNormalColor = @"#ffb473";
//static NSString *const dnSendButtonTintAbnormalColor = @"#C9DCCA";
static NSString *const dnSendButtonTintAbnormalColor = @"#ffb473";
...
- (void)setupViews
{
    ...
    [_sendButton setTitle:NSLocalizedStringFromTable(@"send", @"DNImagePicker", @"选择")
