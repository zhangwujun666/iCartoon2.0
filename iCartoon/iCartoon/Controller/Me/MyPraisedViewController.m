...
@interface MyPraisedViewController ()

@end

@implementation MyPraisedViewController
...
- (void)viewDidLoad {
    ...
    self.navigationItem.title = @"我得到的赞";
