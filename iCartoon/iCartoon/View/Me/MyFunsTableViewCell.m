...
@implementation MyFunsTableViewCell
...
- (void)setAuthorInfo:(ConcernedAuthorInfo *)authorInfo {
    ...
    if(_authorInfo) {
        [self.iconImageView sd_setImageWithURL:[NSURL URLWithString:_authorInfo.avatarUrl] placeholderImage:[UIImage imageNamed:@"ic_avatar_default"]];
