...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if(self) {
        ...
        [self.iconImageView.layer setCornerRadius:self.imageView.frame.size.width / 2];
        [self.iconImageView.layer setBorderWidth:0.5f];
        [self.iconImageView.layer setBorderColor:UIColorFromRGB(0xc0c0c0).CGColor];
        self.iconImageView.contentMode = UIViewContentModeScaleAspectFill;
        self.iconImageView.backgroundColor = I_BACKGROUND_COLOR;
...
- (CGRect)titleRectForContentRect:(CGRect)contentRect {
    ...
    CGFloat titleHeight = TRANS_VALUE(30.0f);
