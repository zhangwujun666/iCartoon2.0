...
@implementation SearchAuthorButton
...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if(self) {
        ...
        CGFloat imageMarginLeft = (frame.size.width - TRANS_VALUE(46.0f)) / 2;
        CGFloat imageMarginTop = TRANS_VALUE(14.0f);
        CGFloat imageWidth = TRANS_VALUE(46.0f);
        CGFloat imageHeight = TRANS_VALUE(46.0f);
...
- (void)setTitle:(NSString *)title {
    ...
    UIColor *normalTitleColor = [UIColor clearColor];
    UIColor *pressedTitleColor = [UIColor clearColor];
...
- (CGRect)titleRectForContentRect:(CGRect)contentRect {
    ...
    CGFloat titleMarginLeft = (width - TRANS_VALUE(46.0f)) / 2;
    CGFloat titleMarginTop = TRANS_VALUE(14.0f);
...
- (CGRect)imageRectForContentRect:(CGRect)contentRect {
    CGFloat width = self.frame.size.width;
    CGFloat imageMarginLeft = (width - TRANS_VALUE(46.0f)) / 2;
    CGFloat imageMarginTop = TRANS_VALUE(14.0f);
    CGFloat imageWidth = TRANS_VALUE(46.0f);
    CGFloat imageHeight = TRANS_VALUE(46.0f);
